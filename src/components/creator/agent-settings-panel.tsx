  ...
  const copy =
    locale === "zh"
      ? {
          ...
          endpoint: "direct_http / mcp_server 需要填写调用端点 URL",
          mcpTool: "mcp_server 需要填写 MCP 工具名称",
  ...
  const copy =
    locale === "zh"
      ? {
          ...
          slugHint: "Agent 标识（slug）用于 A2A、Agent Card 和外部链接，不能在设置里修改。",
          lifecycle: "生命周期",
      ...
      : {
          ...
          price: "External reference price (USD cents/invocation, optional)",
