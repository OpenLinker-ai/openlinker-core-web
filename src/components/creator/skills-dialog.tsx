...
export function SkillsDialog({
  ...
  const copy =
    locale === "zh"
      ? {
          ...
          title: "技能",
          desc: `选择该 Agent 对外声明的 Skill，最多 ${MAX_SKILLS_PER_AGENT} 个；保存后会影响任务推荐和 Benchmark。`,
          loading: "加载技能目录中...",
          cancel: "取消",
          saving: "保存中...",
          save: "保存",
      ...
      : {
          ...
          title: "Skills",
          desc: `Choose the Skills this Agent declares publicly, up to ${MAX_SKILLS_PER_AGENT}. Saving affects task matching and benchmarks.`,
  ...
  }, [apiFetch, agentSlug, copy.loadFailed, onClose, open]);
  ...
  return (
    ...
    >
      <DialogContent className="max-h-[calc(100vh-48px)] overflow-hidden sm:max-w-2xl">
        <DialogHeader>
