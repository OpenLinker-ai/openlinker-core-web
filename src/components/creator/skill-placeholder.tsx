  ...
  const copy =
    locale === "zh"
      ? {
          ...
          joiner: "、",
          empty: "公开 Agent 后，用每行的 Skill 按钮声明能力。声明后会影响任务推荐排序，也会显示在公开详情页。",
        }
      : {
          ...
          joiner: ", ",
          empty: "After an Agent is public, use the Skill button on each row to declare capabilities. Claims affect task matching and appear on the public detail page.",
        };
