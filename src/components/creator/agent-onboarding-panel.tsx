...
export function AgentOnboardingPanel({
  ...
  const saveCapability = async () => {
    ...
    try {
      ...
      toast.error(errorMessage(err, copy.capabilitySaveFailed));
    } finally {
  ...
  const addExample = async () => {
    ...
    try {
      ...
      toast.error(errorMessage(err, copy.exampleAddFailed));
    } finally {
  ...
  const deleteExample = async (exampleId: string) => {
    ...
    try {
      ...
      toast.error(errorMessage(err, copy.exampleDeleteFailed));
    } finally {
  ...
  const runDryRun = async () => {
    ...
    try {
      ...
      if (res.result === "pass") {
        ...
        toast.error(res.error ?? copy.healthFail);
      }
    } catch (err) {
      toast.error(errorMessage(err, copy.healthRunFailed));
    } finally {
  ...
  const updateVisibility = async (visibility: OnboardingAgent["visibility"]) => {
    ...
    try {
      ...
      toast.error(errorMessage(err, copy.visibilityFailed));
    } finally {
  ...
  const requestCertification = async () => {
    ...
    try {
      ...
      toast.error(errorMessage(err, copy.certFailed));
    } finally {
