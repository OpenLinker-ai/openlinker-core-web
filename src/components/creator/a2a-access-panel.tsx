  ...
  const copy =
    locale === "zh"
      ? {
          ...
          creating: "创建中",
          create: "创建",
          tokenHint: "Agent Token 明文仅显示一次，请配置到 Runtime Worker。它只绑定当前 Agent。",
          copied: "已复制",
          copyToken: "复制 Token",
          revoke: "撤销",
      ...
      : {
          ...
          creating: "Creating",
          create: "Create",
          tokenHint: "The Agent Token plaintext is shown only once. Configure it in Runtime Worker. It is bound to this Agent only.",
          copied: "Copied",
