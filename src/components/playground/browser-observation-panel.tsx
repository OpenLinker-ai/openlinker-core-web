...
const copy = {
  zh: {
    ...
    terminalDescription: "本轮已结束；展开可查看本轮画面状态，继续发送会沿用会话与浏览器状态",
    detail: "完整详情",
    running: "可观察",
    following: "持续跟随",
    stopFollowing: "停止跟随",
  ...
  en: {
    ...
    terminalDescription: "This turn has ended; expand to see what its view holds. Continue with the same session",
    detail: "Full details",
    running: "Observable",
    following: "Following",
