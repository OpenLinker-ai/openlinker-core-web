      ...
      ? {
          ...
          cards: [
            ...
            { href: "/registry", icon: "target" as IconName, title: "Agent 库", desc: "浏览公开 Agent、Skill 和调用入口。" },
            {
              ...
              desc: isCreator ? "管理已接入 Agent、Agent Token、Skill 和调用记录。" : "把 Agent 接入当前实例，并在我的 Agent 中继续配置。",
            },
      ...
      : {
          ...
          cards: [
            ...
            { href: "/registry", icon: "target" as IconName, title: "Registry", desc: "Browse public Agents, Skills, and run entry points." },
            {
              ...
              desc: isCreator ? "Manage connected Agents, Agent Tokens, Skills, and runs." : "Connect an Agent to this instance, then continue setup under My Agents.",
            },
