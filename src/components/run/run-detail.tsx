  ...
  const copy =
    locale === "zh"
      ? {
          ...
          errorDetail: "错误详情",
          artifacts: "运行产物",
          delegatedNote: "该子运行的结果返回给父运行，不单独触发外部投递或费用记录。",
          meta: "元信息",
          returnParent: "返回父运行",
          deliveryStatus: "交付状态",
          inbox: "站内通知",
      ...
      : {
          ...
          delegatedNote: "This child run returns its result to the parent run and does not trigger separate external delivery or cost records.",
          meta: "Metadata",
    ...
    <div className="space-y-5">
      <section>
        <div className="grid items-end gap-5 md:grid-cols-[minmax(0,1fr)_auto]">
          <div>
            <div className="ol-kicker">run detail</div>
