...
import type { A2ASkillRef, ParentRunSummary } from "@/components/a2a/parent-run-directory";
          ...
          <div className="border-b border-[color:var(--ol-line)] bg-white/70 p-5">
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {typeof activeParent?.active_runtime_token_count === "number" ? (
                  <span className="ol-chip ol-chip-mint">
                    {copy.boundTokens} {activeParent.active_runtime_token_count}
                  </span>
                ) : null}
              </div>
            </div>
                      ...
                      <p className="mt-1 text-[12.5px] font-bold leading-5 text-[color:var(--ol-muted)]">
                        {locale === "zh" ? (
                          ...
                          <>
                            ...
                            its own runtime credential; OpenLinker creates the child
