  ...
  const copy =
    locale === "zh"
      ? {
          ...
          body: "每条会话按 root_context_id / 根运行聚合，fan-out 和串行委派会收在同一棵调用树里。",
          searchLabel: "搜索 Agent、Skill、会话或 run_id",
          searchPlaceholder: "输入 Agent 名称、slug、Skill、tag、root_context_id 或 run_id",
          searchAction: "搜索",
          clearSearch: "清除",
      ...
      : {
          ...
          body: "Each session is grouped by root_context_id / root run, so fan-out and serial delegation stay in one call tree.",
          searchLabel: "Search Agent, Skill, session, or run_id",
          searchPlaceholder: "Agent name, slug, Skill, tag, root_context_id, or run_id",
          searchAction: "Search",
          clearSearch: "Clear",
