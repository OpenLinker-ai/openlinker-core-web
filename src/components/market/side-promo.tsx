  ...
  const copy =
    locale === "zh"
      ? {
          ...
          categoryBody: "结合 Skill 声明、可用性、能力测评和公开的最近运行记录进行判断。",
          skills: "查看 Skill 目录",
          workflow: "A2A / MCP",
      ...
      : {
          ...
          categoryBody: "Use Skill claims, availability, benchmarks, and public recent run history to decide whether an Agent fits.",
