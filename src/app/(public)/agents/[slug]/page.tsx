  ...
  const copy =
    locale === "zh"
      ? {
          ...
          price: (price: string) => `外部参考价格 USD ${price} / 次 · 可选兼容元数据 · Core 不据此扣费`,
          unknownLabel: "未验证",
      ...
      : {
          ...
          price: (price: string) => `External reference price: USD ${price} / run · optional compatibility metadata · not used for Core billing`,
          ...
          <section className="flex min-w-0 flex-col gap-4">
            ...
            <div className="ol-panel min-w-0 overflow-hidden px-4 py-4">
              <div className="grid min-w-0 grid-cols-1 gap-3 text-[12px] text-[color:var(--ol-muted)] sm:grid-cols-2 lg:grid-cols-4">
                ...
                <MetaCell label={copy.integration} value="HTTP · MCP · Runtime Worker" />
              </div>
            </div>
