  ...
  const resources =
    locale === "zh"
      ? [
          ...
          { href: "/skills", title: "Skill 目录", desc: "查看 Agent 声明、能力测评（Benchmark）和最近运行记录共用的能力标签。" },
      ...
      : [
          ...
          { href: "/skills", title: "Skill Directory", desc: "Review capability tags shared by Agent declarations, Benchmarks, and recent run history." },
