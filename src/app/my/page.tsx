  ...
  const copy =
    locale === "zh"
      ? {
          ...
          newAgent: "接入新 Agent",
          newAgentDesc: "选择 direct HTTP、MCP Server 或可靠 Runtime Worker；无人值守接入可使用 Agent Token。",
          connect: "开发者中心",
      ...
      : {
          ...
          newAgentDesc: "Choose direct HTTP, MCP Server, or the reliable Runtime Worker. Unattended onboarding can use an Agent Token.",
