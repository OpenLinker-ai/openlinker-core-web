  ...
  const copy =
    locale === "zh"
      ? {
          ...
          newAgent: "接入新 Agent",
          newAgentDesc: "HTTP Endpoint、MCP Server 或 Runtime Pull，接入后回到创作者中心管理。",
          connect: "接入中心",
      ...
      : {
          ...
          newAgentDesc: "Use HTTP Endpoint, MCP Server, or Runtime Pull, then manage the Agent from Creator Hub.",
