...
function maintenanceCopy(locale: "zh" | "en"): Copy {
  return locale === "zh"
    ? {
        ...
        members: "Core 实例",
        membersBody:
          "实例必须使用同一发布版本、数据库结构和 Runtime contract，在线数量也要符合预期。",
        ...
        states: {
          ready: {
            label: "可以开始新任务",
            title: "运行链路已就绪",
            body: "Core、数据库、Runtime contract 和唤醒通道一致，新任务可以进入；WebSocket 为主通道，Pull v2 可在连接不稳定时接续。",
            chip: "ol-chip-green",
        ...
        blockerMessages: {
          ...
          current_contract_mismatch: "数据库中的 Runtime contract 与当前 Core 不一致。",
          ...
          member_contract_mismatch: "Core 实例的 Runtime contract 不一致。",
