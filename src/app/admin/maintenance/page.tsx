...
function maintenanceCopy(locale: "zh" | "en"): Copy {
  return locale === "zh"
    ? {
        ...
        members: "Core 实例",
        membersBody:
          "实例必须使用同一发布版本、数据库结构和 Runtime 协议版本，在线数量也要符合预期。",
        ...
        memberReady: "就绪",
        memberBlocked: "被门禁阻止",
        memberDraining: "正在停止接收新任务",
        memberStale: "已离线",
        memberIdentity: "展开版本与协议详情",
        unknownBlocker:
        ...
        states: {
          ready: {
            label: "可以开始新任务",
            title: "运行链路已就绪",
            body: "Core、数据库、Runtime 协议版本和唤醒通道一致，新任务可以进入；WebSocket 为主通道，连接不稳定时由长轮询接续。",
            chip: "ol-chip-green",
          ...
          maintenance: {
            label: "维护中",
            title: "新任务已暂停",
            body: "集群处于强维护状态。已有连接只保留安全收尾路径，待版本、数据库结构和 Runtime 协议版本全部核对后再开放。",
            chip: "ol-chip-amber",
            panel: "border-amber-200 bg-amber-50/70",
          },
          blocked: {
            label: "暂不可用",
            title: "运行条件尚未对齐",
            body: "系统已主动阻止新任务进入，避免把任务交给版本或 Runtime 协议不一致的实例。下面列出需要处理的项目。",
            chip: "ol-chip-amber",
        ...
        blockerMessages: {
          ...
          current_contract_mismatch: "数据库中的 Runtime 协议版本与当前 Core 不一致。",
          ...
          member_contract_mismatch: "Core 实例的 Runtime 协议版本不一致。",
    ...
    : {
        ...
        membersBody:
          "Every instance must use the same release, database schema, and Runtime protocol version, with the expected replica count online.",
        ...
        steps: [
          ...
          "Reopen only after every safety check passes",
        ],
        ...
        memberDraining: "Stopping new work",
        memberStale: "Offline",
        memberIdentity: "Show version and protocol details",
        unknownBlocker:
        ...
        states: {
          ready: {
            ...
            body: "Core, database, Runtime protocol version, and wake-up path agree. WebSocket is primary, while long-poll can continue work through an unstable connection.",
            chip: "ol-chip-green",
            panel: "border-emerald-200 bg-emerald-50/70",
          },
          draining: {
          ...
          maintenance: {
            label: "Maintenance",
            title: "New runs are paused",
            body: "The cluster is in hard maintenance. Existing connections retain only safe settlement paths until release, database schema, and Runtime protocol checks pass.",
            chip: "ol-chip-amber",
            panel: "border-amber-200 bg-amber-50/70",
          },
          blocked: {
            ...
            body: "The system is deliberately blocking new runs so work is not assigned to an instance with a mismatched version or Runtime protocol. Resolve the items below first.",
            chip: "ol-chip-amber",
            panel: "border-rose-200 bg-rose-50/70",
          },
        },
        blockerMessages: {
          ...
          current_contract_mismatch: "The database Runtime protocol version does not match this Core release.",
          ...
          member_contract_mismatch: "Core instance Runtime protocol versions do not match.",
          ...
          maintenance: "The cluster is still stopping new work or is in maintenance.",
        },
      };
}
