...
async function loadAgents(params: AdminSearchParams, page: number) {
  ...
  try {
    ...
    return {
      ...
      error: messageFromError(error, "Agent 列表加载失败"),
    };
  }
}
...
export default async function AdminAgentsPage({
  ...
  const { agents, error } = await loadAgents(params, page);
