...
async function loadPublishAgentSkill(request: Request) {
  return fetch(`${getApiBaseUrlForRequest(request)}/skill/publish-agent`, {
...
export async function GET(request: Request) {
  const upstream = await loadPublishAgentSkill(request);
