...
export const agentOnboardingMessages = {
  zh: {
    ...
    adding: "添加中...",
    addExample: "添加示例",
    tokenPolling: "用 Node 设备证书和绑定当前 Agent 的 Agent Token 建立 Runtime v2 会话。默认走 WebSocket；受阻时切换到同一套 Pull v2，不需要当前实例访问你的私网地址。",
...
export const automationAccessMessages = {
  zh: {
    ...
    publish: "接入新 Agent",
    bodySuffix: "Agent Token 的首次注册窗口为 30 分钟；注册成功后，同一枚 Token 会绑定该 Agent，并继续作为运行身份，直到撤销。",
    creating: "生成中...",
  ...
  en: {
    ...
    bodySuffix: "The Agent Token has a 30-minute first-registration window. Once registered, the same Token is bound to that Agent and remains its runtime identity until revoked.",
    creating: "Creating...",
