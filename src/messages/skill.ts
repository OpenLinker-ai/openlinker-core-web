...
export const skillRegistryMessages = {
  zh: {
    ...
    usedFor: "用于",
    entry: "入口",
    usage: "Agent 声明、能力测评、MCP/A2A 和最近运行记录",
    findAgents: "查 Agent",
  ...
  en: {
    ...
    usedFor: "Used for",
    entry: "Entry",
    usage: "Agent capability declarations, benchmarks, MCP/A2A, and recent run history",
    ...
    proposalLead:
      "Submit a Skill proposal when this instance's standard directory is missing a capability. Existing IDs show as merged.",
    proposalID: "Skill ID",
    ...
    signInRequired: "Sign in before submitting a Skill proposal.",
    proposalRequired: "Fill in Skill ID, category, name, and description.",
    proposalSubmitted: "Skill proposal submitted",
    proposalFailed: "Failed to submit the Skill proposal",
