...
export const runDetailMessages = {
  zh: {
    ...
    activeAttempt: "当前执行尝试",
    latestAttempt: "最近执行尝试",
    ...
    replayRun: "使用相同输入重新运行",
    replaying: "正在重新运行…",
    replayStarted: "已创建新运行，原记录保持不变",
    replayFailed: "无法重新运行，请检查当前 Agent、权限和调用设置后重试。",
    cancelRun: "停止运行",
  ...
  en: {
    ...
    privateEvidence: "Visible only to the owner",
    ...
    progressOffered: "An Agent is available and OpenLinker is confirming the assignment.",
    ...
    browserPolicy: "Browser interaction permissions",
    ...
    replayRun: "Run again with the same input",
    replaying: "Starting a new run…",
    replayStarted: "A new run was created; the original record is unchanged",
    replayFailed: "Unable to run again. Check the current Agent, permissions, and call settings, then try again.",
    cancelRun: "Stop run",
